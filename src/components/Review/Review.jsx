...
const Review = () => {
  ...
  return (
    <div className={styles.glav}>
      {visible? <div className={styles.main}>
      ...
      <div className={styles.reverse}>
                ...
                <div className={styles.starsCom}>
                  {star.map((element, index) => {
                    return (
                      <button
                        className={
                          index < item.rating ? styles.focusCom : styles.disfocusCom
                        }
                        onFocus={() => setRating(index + 1)}
                      >
                        {element}
        ...
        <div className={styles.btnDiv}> <button className={visible ? styles.hide: styles.btn} onClick={handleVisible}>Добавить отзыв</button></div>
      </div>
